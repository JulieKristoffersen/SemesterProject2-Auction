const API_URL = "https://v2.api.noroff.dev/auction/listings?_active=true&_seller=true&_bids=true";
...
if (!user) {
  console.log("Not logged in. Bidding will be disabled.");
}
...
function renderCategoryBar() {
  ...
  bar.id = "category-bar";
  bar.className = "flex flex-wrap gap-3 mb-6";
...
function renderListings(listings) {
  ...
  filtered.forEach(l => {
    ...
    card.className = "bg-white shadow-lg rounded-2xl overflow-hidden hover:shadow-xl transition flex flex-col";
    ...
    viewBtn.addEventListener("click", () => openModal(l));
